...
class UMyIDPluginBPLibrary : public UBlueprintFunctionLibrary
{
	...
	UPROPERTY(VisibleAnywhere,BlueprintReadOnly, Category="kybPlugIn")
	FString UserName;
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "SetUserName", Keywords = "SetUserNAme"), Category = "kybPlugIn")
	void SetUserName(const FString& NewName);
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "GetUserName", Keywords = "GetUserNAme"), Category = "kybPlugIn")
	FString GetUserName();
};
